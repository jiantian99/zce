<template>
  <el-dialog
    ...
    <el-form-item label="" prop="messageStatus">
      <el-input v-model="dataForm.messageStatus" placeholder=""></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/article/message/info/${this.dataForm.id}`),
              method: 'get',
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.messageStatus = data.message.messageStatus
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/article/message/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
